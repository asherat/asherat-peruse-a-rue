  ...
  var MapModule = Stapes.subclass({
    ...
    init: function() {
      ...
      GMaps.visualRefresh = true;
        ...
        //Alf 20140524 backgroundColor: "black", now 'water blue', should be config
        //Alf 20140525 zooom:14 , chould be config
      var mapOptions = {
        ...
        mapTypeControlOptions: {
          ...
          position: GMaps.ControlPosition.TOP_RIGHT // Alf was LEFT
        },
...
//      var transitLayer = new google.maps.TransitLayer(); // Alf add transit layer to touchscreen
//      transitLayer.setMap(this.map); //Alf
    ...
    zoom_out: function() {
      var currentZoom = this.map.getZoom(); // Alf - limit maximum Zoom so it doesn't look silly onscreen 20140524
      var zoomMax = 3; // Alf - eventually move this to config 20140524
